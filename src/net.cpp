...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Zaracoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"zaracointools.com", "87.125.248.215"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"zaracointools.com", "testnet-seed.zaracointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Zaracoin is probably already running."), addrBind.ToString().c_str());
        else
